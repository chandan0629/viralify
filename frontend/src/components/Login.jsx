...
export default function Login({ onLogin, onSwitchToSignup, isDarkMode, onToggleTheme, onBack }) {
        ...
        <div className="auth-card">
          ...
          <form className="auth-form" onSubmit={handleSubmit}>
            ...
            <button
              ...
              disabled={loading}
              style={{ marginTop: '12px', background: 'rgba(255, 255, 255, 0.1)', border: '1px solid rgba(255, 255, 255, 0.2)' }}
            >
              🚀 Try Demo Account
            </button>
          </form>
